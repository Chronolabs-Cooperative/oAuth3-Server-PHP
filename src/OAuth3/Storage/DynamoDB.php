 ...
 * <code>
 *  $storage = new OAuth3\Storage\Dynamodb(array("key" => "YOURKEY", "secret" => "YOURSECRET", "region" => "YOURREGION"));
 * </code>
 *
 * Table :
    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($connection, $config = array())
    {
        if (!($connection instanceof DynamoDbClient)) {
            if (!is_array($connection)) {
                throw new \InvalidArgumentException('First argument to OAuth3\Storage\Dynamodb must be an instance a configuration array containt key, secret, region');
            }
    ...
    /* OAuth3\Storage\ClientCredentialsInterface */
    ...
    /* OAuth3\Storage\ClientInterface */
    ...
    /* OAuth3\Storage\AccessTokenInterface */
    ...
    /* OAuth3\Storage\AuthorizationCodeInterface */
    ...
    /* OAuth3\Storage\UserCredentialsInterface */
    ...
    /* OAuth3\Storage\RefreshTokenInterface */
