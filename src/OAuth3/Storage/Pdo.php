    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($connection, $config = array())
    {
        if (!$connection instanceof \PDO) {
            ...
            if (!is_array($connection)) {
                throw new \InvalidArgumentException('First argument to OAuth3\Storage\Pdo must be an instance of PDO, a DSN string, or a configuration array');
            }
    ...
    /**
     * DDL to create OAuth3 database and tables for PDO storage
     *
     * @see https://github.com/dsquier/OAuth3-server-php-mysql
     *
     * @param string $dbName
     * @return string
     */
    public function getBuildSql($dbName = 'OAuth3_server_php')
    {
        $sql = "
