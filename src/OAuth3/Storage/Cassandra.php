 ...
 * <code>
 *     $cassandra = new \phpcassa\Connection\ConnectionPool('OAuth3_server', array('127.0.0.1:9160'));
 * </code>
 *
 * Then, register the storage client:
 * <code>
 *     $storage = new OAuth3\Storage\Cassandra($cassandra);
 *     $storage->setClientDetails($client_id, $client_secret, $redirect_uri);
 * </code>
 *
 * @see test/lib/OAuth3/Storage/Bootstrap::getCassandraStorage
 */
    ...
    public function __construct($connection = array(), array $config = array())
    {
        if ($connection instanceof ConnectionPool) {
            ...
            if (!is_array($connection)) {
                throw new InvalidArgumentException('First argument to OAuth3\Storage\Cassandra must be an instance of phpcassa\Connection\ConnectionPool or a configuration array');
            }
