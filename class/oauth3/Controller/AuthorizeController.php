...
class AuthorizeController implements AuthorizeControllerInterface
{
     ...
     * Constructor
     *
     * @param ClientInterface $clientStorage REQUIRED Instance of OAuth3\Storage\ClientInterface to retrieve client information
     * @param array           $responseTypes OPTIONAL Array of OAuth3\ResponseType\ResponseTypeInterface objects.  Valid array
     *                                       keys are "code" and "token"
     * @param array           $config        OPTIONAL Configuration options for the server:
     * @param ScopeInterface  $scopeUtil     OPTIONAL Instance of OAuth3\ScopeInterface to validate the requested scope
     * @code
     *     $config = array(
