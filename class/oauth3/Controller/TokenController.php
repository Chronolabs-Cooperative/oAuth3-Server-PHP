...
class TokenController implements TokenControllerInterface
{
        ...
        if (is_null($clientAssertionType)) {
            foreach ($grantTypes as $grantType) {
                if (!$grantType instanceof ClientAssertionTypeInterface) {
                    throw new InvalidArgumentException('You must supply an instance of OAuth3\ClientAssertionType\ClientAssertionTypeInterface or only use grant types which implement OAuth3\ClientAssertionType\ClientAssertionTypeInterface');
                }
            }
        }
    ...
    public function grantAccessToken(RequestInterface $request, ResponseInterface $response)
    {
        ...
        if (!isset($this->grantTypes[$grantTypeIdentifier])) {
            /* TODO: If this is an OAuth3 supported grant type that we have chosen not to implement, throw a 501 Not Implemented instead */
         ...
         *
         * @see \OAuth3\GrantType\JWTBearer
         * @see \OAuth3\GrantType\ClientCredentials
         */
        if (!$grantType instanceof ClientAssertionTypeInterface) {
