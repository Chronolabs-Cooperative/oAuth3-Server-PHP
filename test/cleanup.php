...
require_once(dirname(__FILE__).'/../src/OAuth3/Autoloader.php');
OAuth3\Autoloader::register();

// register test classes
OAuth3\Autoloader::register(dirname(__FILE__).'/lib');
...
OAuth3\Storage\Bootstrap::getInstance()->cleanupTravisDynamoDb();
