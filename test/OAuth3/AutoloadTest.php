...
class AutoloadTest extends TestCase
{
    public function testClassesExist()
    {
        ...
        $this->assertTrue(class_exists('OAuth3\Server'));
        $this->assertTrue(class_exists('OAuth3\Request'));
        $this->assertTrue(class_exists('OAuth3\Response'));
        $this->assertTrue(class_exists('OAuth3\GrantType\UserCredentials'));
        $this->assertTrue(interface_exists('OAuth3\Storage\AccessTokenInterface'));
    }
}
